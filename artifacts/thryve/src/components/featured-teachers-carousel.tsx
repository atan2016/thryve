...
function IconUsers() {
  return (
    <svg aria-hidden className="h-3.5 w-3.5 text-[#7F97AC]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198a11.953 11.953 0 01-5.999 1.531A11.953 11.953 0 016 18.719m12 0a5.971 5.971 0 00-.94-3.197M6 18.719a5.971 5.971 0 01.94-3.197m0 0a5.997 5.997 0 0110.12 0M15 6.75a3 3 0 11-6 0 3 3 0 016 0Z" />
    </svg>
  );
}
