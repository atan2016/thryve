...
import { isProdBuild } from "@/lib/constants";
...
export function FeaturedEventsCarousel({ events, isSignedIn = false }: FeaturedEventsCarouselProps) {
        ...
        {events.map((event) => (
          ...
          >
            <div className="relative aspect-[5/3] w-full shrink-0 bg-stone-100">
              <img src={event.imageSrc} alt={event.imageAlt} className="absolute inset-0 h-full w-full object-cover" />
              {event.featuredLabel ? (
            ...
            <div className="flex flex-1 flex-col p-4">
              ...
              {!isSignedIn ? (
                ...
                <a href={event.href} target="_blank" rel="noopener noreferrer" className={ctaClassName}>
                  View Details
                </a>
              ) : (
