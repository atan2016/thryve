  ...
  return (
    <article className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:shadow-md hover:border-[#0A66C2]/30">
      <div className="flex items-start justify-between gap-3">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-slate-100">
          {job.companyLogoUrl ? (
            ...
            <IconBriefcase className="h-5 w-5 text-slate-400" />
          )}
        </div>
      ...
      <a
        ...
        className="mt-4 flex items-center justify-center gap-2 rounded-xl bg-[#1D3B5C] py-2.5 text-sm font-semibold text-white transition hover:bg-[#173050] active:scale-[0.98]"
      >
        Apply Now
